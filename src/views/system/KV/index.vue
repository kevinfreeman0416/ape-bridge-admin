<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="${comment}" prop="key">
        <el-input
      ...
      <el-form-item label="${comment}" prop="val">
        <el-input
    ...
    <el-table v-loading="loading" :data="KVList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="key" />
      <el-table-column label="${comment}" align="center" prop="val" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="${comment}" prop="key">
          <el-input v-model="form.key" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="val">
          <el-input v-model="form.val" placeholder="请输入${comment}" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除KV编号为"' + keys + '"的数据项？').then(function() {
        return delKV(keys);
      }).then(() => {
        this.getList();
